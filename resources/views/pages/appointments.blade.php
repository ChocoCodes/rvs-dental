...
@section('content')
    <div id="appointment-view-container"
        ...
        <div id="list-panel"
             class="flex-1 min-h-0 flex flex-col bg-white border rounded-xl shadow-sm transition-all duration-300 overflow-hidden">
            ...
            <div id="calendar-panel" class="hidden flex-1 flex flex-col min-h-0 overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b flex justify-between items-center sticky top-0 z-10">
                ...
                <div class="flex-1 overflow-y-auto">
                    ...
                    <!-- Calendar Grid -->
                    <div id="calendar-grid" class="grid grid-cols-7 divide-x divide-y border-b"></div>
                </div>
            </div>
        </div>
